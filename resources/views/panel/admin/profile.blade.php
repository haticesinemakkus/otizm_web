...
<div class="row">
  <div class="col-xl-12">
	...
	<div id="panel-1" class="panel">
	  ...
	  <form ajax-form method="POST" action="{{ route('panel.profile_save') }}">
			...
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group mb-2">
						...
						<input type="text" class="form-control" name="surname" value="{{ $item->surname ?? '' }}" required>
                        @error('surname')
                            <span class="badge badge-danger">{{ $message}}</span>
                        @enderror
					</div>
			...
			<div class="row">
				<div class="col-6">
					<div class="form-group mb-2">
					  ...
					  <input type="text" class="form-control" name="email" value="{{ $item->email ?? '' }}" required autocomplete="off">
                      @error('email')
                            <span class="badge badge-danger">{{ $message}}</span>
                        @enderror
					</div>
				...
				<div class="col-6">
					<div class="form-group mb-2">
					  ...
					  <input type="text" class="form-control" name="phone" value="{{ $item->phone ?? '' }}" required autocomplete="off" mask="phone"  >
                      @error('phone')
                            <span class="badge badge-danger">{{ $message}}</span>
                        @enderror
					</div>
			...
			<div class="row">
				...
				<div class="col-6">
					<div class="form-group mb-2">
						...
						<input type="password" class="form-control" name="new_password2" autocomplete="off">
                        @error('new_password')
                            <span class="badge badge-danger">{{ $message}}</span>
                        @enderror
					</div>
