                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="email" class="form-control" name="email" value="{{ old('email') ? old('email') : $item->email }}" required autocomplete="off">
                                            @error('email')
                                                <span class="badge badge-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" class="form-control" name="phone" value="{{ old('phone') ? old('phone') : $item->phone }}" required autocomplete="off" mask="phone">
                                            @error('phone')
                                                <span class="badge badge-danger">{{$message}}</span>
                                            @enderror
                                        </div>
